...
void Print(const susy::Muon& m) {
  
  std::cout <<"VIIIIIR muon" <<std::endl;
  
  std::cout << "\ttype : " << m.type << std::endl;
  std::cout << "\tnMatches : " << m.nMatches << std::endl;
  std::cout << "\tnValidHits : " << m.nValidHits << std::endl;
  std::cout << "\tnValidTrackerHits : " << m.nValidTrackerHits << std::endl;
  std::cout << "\tnValidMuonHits : " << m.nValidMuonHits << std::endl;
  std::cout << "\tnChambers : " << m.nChambers << std::endl;
  std::cout << "\ttimeNDof : " << m.timeNDof << std::endl;
  std::cout << "\ttimeDirection : " << m.timeDirection << std::endl;
  
//  //    std::cout << "\ttimeAtIp : " << m. << std::endl;
// //     std::cout << "\ttimeAtIpError : " << m. << std::endl;
// //     std::cout << "\tcaloCompatibility : " << m. << std::endl;
// //     std::cout << "\temEnergy : " << m. << std::endl;
// //     std::cout << "\thadEnergy : " << m. << std::endl;
// //     std::cout << "\ttrackIsoR03 : " << m. << std::endl;
// //     std::cout << "\tecalIsoR03 : " << m. << std::endl;
// //     std::cout << "\thcalIsoR03 : " << m. << std::endl;
// //     std::cout << "\ttrackIsoR05 : " << m. << std::endl;
// //     std::cout << "\tecalIsoR05 : " << m. << std::endl;
// //     std::cout << "\thcalIsoR05 : " << m. << std::endl;
    
// //     std::cout << "\tsumChargedHadronPt03 : " << m. << std::endl;
// //     std::cout << "\tsumChargedParticlePt03 : " << m. << std::endl;
// //     std::cout << "\tsumNeutralHadronEt03 : " << m. << std::endl;
// //     std::cout << "\tsumPhotonEt03 : " << m. << std::endl;
// //     std::cout << "\tsumNeutralHadronEtHighThreshold03 : " << m. << std::endl;
// //     std::cout << "\tsumPhotonEtHighThreshold03 : " << m. << std::endl;
// //     std::cout << "\tsumPUPt03 : " << m. << std::endl;
    
// //     std::cout << "\tsumChargedHadronPt04 : " << m. << std::endl;
// //     std::cout << "\tsumChargedParticlePt04 : " << m. << std::endl;
// //     std::cout << "\tsumNeutralHadronEt04 : " << m. << std::endl;
// //     std::cout << "\tsumPhotonEt04 : " << m. << std::endl;
// //     std::cout << "\tsumNeutralHadronEtHighThreshold04 : " << m. << std::endl;
// //     std::cout << "\tsumPhotonEtHighThreshold04 : " << m. << std::endl;
// //     std::cout << "\tsumPUPt04 : " << m. << std::endl;
    
// //     std::cout << "\ttrackIndex : " << m. << std::endl;             // tracker only
// //     std::cout << "\tstandAloneTrackIndex : " << m. << std::endl;   // muon detector only
// //     std::cout << "\tcombinedTrackIndex : " << m. << std::endl;     // combined
// //     std::cout << "\tmomentum : "; Print(m.momentum);
std::cout << "\tmomentum : "; Print(m.momentum);
// //   std::map<TString, UChar_t> idPairs;    
  
//   std::cout << "\tidPairs : ";
//   for(std::map<TString, UChar_t>::const_iterator it = m.idPairs.begin();
//       it != m.idPairs.end(); it++) {
...
//   //     std::cout << std::endl;
 ...
 //---VIR---
void Print(const susy::Electron& e) {
  
  std::cout <<"VIIIIIR electron" <<std::endl;
  
  std::cout << "\tfidBit : " << e.fidBit << std::endl;
  std::cout << "\tboolPack : " << e.boolPack << std::endl;
  std::cout << "\tscPixCharge : " << e.scPixCharge << std::endl;
  
  std::cout << "\teSuperClusterOverP : " << e.eSuperClusterOverP << std::endl;
  std::cout << "\teSeedClusterOverP : " << e.eSeedClusterOverP << std::endl;
  std::cout << "\teSeedClusterOverPout : " << e.eSeedClusterOverPout << std::endl;
  std::cout << "\teEleClusterOverPout : " << e.eEleClusterOverPout << std::endl;
  std::cout << "\tdeltaEtaSuperClusterTrackAtVtx : " << e.deltaEtaSuperClusterTrackAtVtx << std::endl;
  std::cout << "\tdeltaEtaSeedClusterTrackAtCalo : " << e.deltaEtaSeedClusterTrackAtCalo << std::endl;
  std::cout << "\tdeltaEtaEleClusterTrackAtCalo : " << e.deltaEtaEleClusterTrackAtCalo << std::endl;
  std::cout << "\tdeltaPhiSuperClusterTrackAtVtx : " << e.deltaPhiSuperClusterTrackAtVtx << std::endl;
  // std::cout << "\tdeltaPhiSeedClusterTrackAtCalo : " << e.deltaPhiSeedClusterTrackAtCal << std::endl;
  // std::cout << "\tdeltaPhiEleClusterTrackAtCalo : " << e.eltaPhiEleClusterTrackAtCalo << std::endl;


  std::cout << "\tshFracInnerHits : " << e.shFracInnerHits << std::endl;
       
  std::cout << "\tsigmaEtaEta : " << e.sigmaEtaEta << std::endl;
  std::cout << "\tsigmaIetaIeta : " << e.sigmaIetaIeta << std::endl;
  std::cout << "\te1x5 : " << e.e1x5 << std::endl;
  std::cout << "\te2x5Max : " << e.e2x5Max << std::endl;
  std::cout << "\te5x5 : " << e.e5x5 << std::endl;
  std::cout << "\thcalDepth1OverEcal : " << e.hcalDepth1OverEcal << std::endl;          // hadronic energy on depth1 / em enrgy
  std::cout << "\thcalDepth2OverEcal : " << e.hcalDepth2OverEcal << std::endl;          // hadronic energy on depth2 / em enrgy

  std::cout << "\tdr03TkSumPt : " << e.dr03TkSumPt << std::endl;
  std::cout << "\tdr03EcalRecHitSumEt : " << e.dr03EcalRecHitSumEt  << std::endl;
  std::cout << "\tdr03HcalDepth1TowerSumEt : " << e.dr03HcalDepth1TowerSumEt << std::endl;
  std::cout << "\tdr03HcalDepth2TowerSumEt : " << e.dr03HcalDepth2TowerSumEt  << std::endl;

  std::cout << "\tdr04TkSumPt : " << e.dr04TkSumPt << std::endl;
  std::cout << "\tdr04EcalRecHitSumEt : " << e.dr04EcalRecHitSumEt  << std::endl;
  std::cout << "\tdr04HcalDepth1TowerSumEt : " << e.dr04HcalDepth1TowerSumEt << std::endl;
  std::cout << "\tdr04HcalDepth2TowerSumEt : " << e.dr04HcalDepth2TowerSumEt  << std::endl;

    // Conversion info
  std::cout << "\tconvDist : " << e.convDist << std::endl;
  std::cout << "\tconvDcot : " << e.convDcot << std::endl;
  std::cout << "\tconvRadius : " << e.convRadius << std::endl;

  std::cout << "\tchargedHadronIso : " << e.chargedHadronIso << std::endl;
  std::cout << "\tneutralHadronIso : " << e.neutralHadronIso << std::endl;
  std::cout << "\tphotonIso : " << e.photonIso << std::endl;
  std::cout << "\tmvaStatus : " << e.mvaStatus << std::endl;
  std::cout << "\tmva : " << e.mva << std::endl;

  std::cout << "\tbremClass : " << (int)e.bremClass << std::endl;
  std::cout << "\tfbrem : " << e.fbrem << std::endl;

  std::cout << "\tecalEnergy : " << e.ecalEnergy << std::endl;                  // corrected
  std::cout << "\tecalEnergyError : " << e.ecalEnergy << std::endl;             // correction error
  std::cout << "\ttrackMomentumError : " << e.trackMomentumError << std::endl;

  std::cout << "\tgsfTrackIndex : " << e.gsfTrackIndex  << std::endl;
  std::cout << "\tclosestCtfTrackIndex : " << e.closestCtfTrackIndex << std::endl;
  std::cout << "\telectronClusterIndex : " << e.electronClusterIndex << std::endl;
  std::cout << "\tsuperClusterIndex : " << e.superClusterIndex << std::endl;
  ...
  if(e.trackPositions.size() == 0) {
    std::cout << "(0)" << std::endl;
  }
  else {
    std::cout << std::endl;
    for(std::map<TString,TVector3>::const_iterator it = e.trackPositions.begin();
	it != e.trackPositions.end(); it++) {
      std::cout << "\t\t[ " << it->first << " : "; Print(it->second); std::cout << " ]" << std::endl;
    }
  }

  if(e.trackMomentums.size() == 0) {
    std::cout << "(0)" << std::endl;
  }
  else {
    std::cout << std::endl;
    for(std::map<TString,TLorentzVector>::const_iterator it = e.trackMomentums.begin();
	it != e.trackMomentums.end(); it++) {
      std::cout << "\t\t[ " << it->first << " : "; Print(it->second); std::cout << " ]" << std::endl;
    }
  }
...
//     std::map<TString,Float_t> idPairs;
  std::cout << "\tvertex : "; Print(e.vertex);
  std::cout << "\tmomentum : "; Print(e.momentum);
  std::cout << "\tidPairs : ";
//   for(std::map<TString,UChar_t>::const_iterator it = e.idPairs.begin(); it != e.idPairs.end(); it++ ){
//     std::cout << "(" << it->first << ", " << int(it->second) << ") ";
//   }
//   std::cout << std::endl;
...
void Print(const susy::Event& event) {
  ...
  // --- VIR ---
  for(std::vector<susy::Muon>::const_iterator it = event.muons.begin(); it != event.muons.end(); it++) {
    Print(*it);
  }
  std::cout << std::endl;
  // --- /. VIR
  ...
  // --- VIR ---
  for(std::map<TString,susy::ElectronCollection>::const_iterator it = event.electrons.begin(); it != event.electrons.end(); it++) {
    //    std::cout <<"VIIIIIR electrons" <<std::endl; 
    std::cout << it->first << " size(" << it->second.size() << ") ======>" << std::endl;
    for(std::vector<susy::Electron>::const_iterator it2 = it->second.begin(); it2 != it->second.end(); it2++) {
      Print(*it2);
    }
  }
  std::cout << std::endl;
